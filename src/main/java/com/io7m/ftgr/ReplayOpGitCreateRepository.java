...
public final class ReplayOpGitCreateRepository implements ReplayOperationType
{
  private static final Logger LOG;

  static {
    LOG = LoggerFactory.getLogger(ReplayOpGitCreateRepository.class);
  }

  private final GitRepositorySpecificationType repos;
  private final GitExecutableType              exec;

  public ReplayOpGitCreateRepository(
  ...
  {
    try {
      ReplayOpGitCreateRepository.LOG.info(
        "creating repository {}", this.repos.getDirectory());
