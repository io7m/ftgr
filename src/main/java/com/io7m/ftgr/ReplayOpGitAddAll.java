...
public final class ReplayOpGitAddAll implements ReplayOperationType
{
  private static final Logger LOG;

  static {
    LOG = LoggerFactory.getLogger(ReplayOpGitAddAll.class);
  }

  private final GitExecutableType              git;
  private final GitRepositorySpecificationType repos;

  public ReplayOpGitAddAll(
